...
#    C_ROOM01 = cv2.inRange(Crop_ROOM02, lower_red, upper_red)
    ...
    C_ROOM03 = cv2.inRange(Crop_ROOM02, lower_red, upper_red)
    C_ROOM04 = cv2.inRange(Crop_ROOM02, lower_red, upper_red)
    C_ROOM05 = cv2.inRange(Crop_ROOM02, lower_red, upper_red)
    C_ROOM06 = cv2.inRange(Crop_ROOM02, lower_red, upper_red)
    C_ROOM07 = cv2.inRange(Crop_ROOM02, lower_red, upper_red)
    C_ROOM08 = cv2.inRange(Crop_ROOM02, lower_red, upper_red)
    C_ROOM09 = cv2.inRange(Crop_ROOM02, lower_red, upper_red)
    C_ROOM10 = cv2.inRange(Crop_ROOM02, lower_red, upper_red)
